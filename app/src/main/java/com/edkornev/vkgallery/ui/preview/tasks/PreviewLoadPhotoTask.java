package com.edkornev.vkgallery.ui.preview.tasks;
 ...
 */
public class PreviewLoadPhotoTask extends BaseTask<Long, Void, PhotoListResponse> {

    private static final String TAG = PreviewLoadPhotoTask.class.getSimpleName();
    ...
    public PreviewLoadPhotoTask(TaskListener<PhotoListResponse> taskListener) {
        super(taskListener);
    }
